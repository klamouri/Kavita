        ...
        foreach (var (key, value) in tokens)
        {
            switch (key.ToLowerInvariant())
            {
                ...
                case "malid":
                    ...
                    break;
                case "hardcoverid":
                    if (int.TryParse(value, NumberStyles.Integer, CultureInfo.InvariantCulture, out var hc))
                    {
                        info.HardcoverId = hc;
                    }
                    break;
                ...
                case "comicvineseriesid":
                    ...
                    break;
                case "mangabakaid":
                    if (long.TryParse(value, NumberStyles.Integer, CultureInfo.InvariantCulture, out var mb))
                    {
                        info.MangaBakaId = mb;
                    }
                    break;
